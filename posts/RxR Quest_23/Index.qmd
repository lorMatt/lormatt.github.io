...
About a year after the beginning of the survey's subministration, I was involved as a data analyst, and contributed to the writing of the final report (*forthcoming*). Below is a selection of my contributions, both in terms of internal and external communication.

Since the whole work was written in Italian, some of the code and visualisation below may not be translated. I apologise for the inconvenience.
...
::: {.column width="30%"}
The main problem with the questionnaire was its coverage. In discussing the problem with the rest of our organisation, this geographical visualisation was the best way to explain the reason behind our hesitation in performing statistical inference.

The gray areas are administrative areas (comuni) that we weren't able to reach with the current resources.
:::
:::
