...
About a year after the beginning of the survey's distribution, I was involved as a data analyst, and contributed to the writing of the final report (*forthcoming*). Below is a selection of my contributions, both in terms of internal and external communication.

Since the whole work was written in Italian, the graphs and charts are not translated. The source code and data is available at the link on the top right, which leads to Lucia Temperini and I's GitHub repository. Although code boxes were included in the post for reference, the final graphics were post-produced in Pixelmator. These are included in the gallery right below, before the actual post.
...
The extremely unequal socio-demographical composition of the sample did not reassure as in any way. The choice of snow-balling as a distribution method introduced significant self-selection problems, which lead to the situation shown in the figure
...
The figure was decomposed by occupation, in order to try and catch at least some hints regarding the social composition of the respective groups.
