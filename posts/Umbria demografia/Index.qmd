...
format:
  html:
    code-tools:
      source: 'https://github.com/lorMatt/internationalDemography.git'
    self-contained: true
    code-fold: true
editor: visual
execute: 
...
Check out the quarto presentation on the topic:

{{< revealjs file="Mattioli_pres.html" height="500px" class="ratio ratio-16x9">}}
